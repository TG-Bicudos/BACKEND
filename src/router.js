...
const imagensController = require('./controllers/armadilhasController');
const imagensMiddleware = require('./middlewares/imagensMiddleware');

// Rotas de armadilhas
router.get('/armadilhas', armadilhaController.getAll);
router.post('/armadilhas', armadilhaMiddleware.validateNome, armadilhaMiddleware.validateLatitude, armadilhaMiddleware.validateLongitude, armadilhaMiddleware.validateForms, armadilhaController.createArmadilha);
...
router.put('/pastas/:id', pastasMiddleware.validateIdPasta, pastasMiddleware.validateIdDispositivo, pastasMiddleware.validateNomePasta, pastasMiddleware.validateForms, pastasController.updatePasta);
